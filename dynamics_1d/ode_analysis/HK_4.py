"""
Analysis of number of clusters for varying parameter R when n is fixed.
...
for r in R:
    ...
    # SIMULATION
    x_1 = HK_ode(r, n, x0, h, stop, 'LAST_STEP', include_self = False)
    x_2 = HK_ode(r, n, x0, h, stop, 'LAST_STEP', include_self = True)
