...
is given by a plot. The analysis is performed using the Monte Carlo approach:
...
for i in range(1000):
    ...
    for n in N:
        ...
        for r in R:
            ...
            # SIMULATION
            x = HK_discrete(r, n, x0, stop, 'FULL', include_self = True)
...
im2 = ax2.imshow(data2, cmap = "Oranges", origin = "lower", vmin = 0, vmax = 10)
