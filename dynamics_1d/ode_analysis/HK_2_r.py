"""
Analysis of a number of clusters and steps needed for varying parameters R and N with radicals included.
This script run the Monte Carlo simulation for the opinion dynamics generated by using an ODE HK model
...
for i in range(100):
    ...
    for n in N:
        ...
        for r in R:
            ...
            # SIMULATION
            x = HK_ode_r(r, n, x0, n_rad, x0_rad, h, stop, 'FULL', include_self = True)
