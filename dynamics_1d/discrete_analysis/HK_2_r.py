...
when radicals are included. This script runs a Monte Carlo simulation for the opinion
dynamics generated by using a discrete HK model. The number of clusters/steps for each pair
of parameters is given on a 2D raster. The analysis is performed using the Monte Carlo approach:
...
for i in range(1000):
    ...
    for n in N:
        ...
        for r in R:
            ...
            # SIMULATION
            x = HK_discrete_r(r, n, x0, n_rad, x0_rad, stop, 'FULL', include_self = True)
